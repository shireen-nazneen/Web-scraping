...
def scrape_movie_details_with_cast(link_1,movie_name,file):
    ...
    if (os.path.exists(file)):
        ...
        find_div_dir=url_page_soup.select("li[data-testid='storyline-genres']")
        for i in find_div_dir:
            find_director=i.find_all("a")
...
print(scrape_movie_details_with_cast(link_1,movie_name,file))
